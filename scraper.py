...
# Keywords for non-daily, seasonal, or holiday items to skip
EXCLUDED_KEYWORDS = [
    "rakhi", "rakshabandhan", "lumba", "diwali", "pichkari", 
    "crackers", "rangoli", "christmas", "santa", "easter", "halloween"
]
    ...
    while True:
        ...
        try:
            ...
            for product in products:
                ...
                # Skip non-daily / seasonal items like Rakhi
